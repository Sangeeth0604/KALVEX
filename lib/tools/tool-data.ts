...
export const TOOLS_DATA: ToolItem[] = [
  ...
  },
  {
    ...
    category: "convert",
    categoryLabel: "Convert",
    tagline: "Convert between PNG, JPG, and WEBP images, or render PDF pages into images.",
    description: "Convert raster image formats (PNG, JPG, WEBP) and render PDF document pages into high-resolution images in browser memory.",
    inputFormats: ["PNG", "JPG", "WEBP", "PDF"],
    outputFormat: "PNG, JPG, WEBP",
    executionModel: "client-canvas",
    executionLabel: "Canvas Engine",
    status: "available",
    statusLabel: "Available",
    tags: ["image", "png", "jpg", "webp", "pdf", "convert", "render"],
  },
  {
    id: "markdown-to-pdf",
  ...
  },
  {
    ...
    slug: "target-size-compressor",
    name: "1 MB Compressor",
    category: "compress",
    categoryLabel: "Compress",
    tagline: "Compress supported files to 1 MB or less, or specify a custom target size.",
    description: "Reduce supported files (JPG, PNG, WebP, PDF) to 1 MB or less directly in your browser.",
    inputFormats: ["JPG", "PNG", "WEBP", "PDF"],
    outputFormat: "JPG, PNG, WEBP, PDF",
    executionModel: "in-memory-worker",
    executionLabel: "Target Engine",
    status: "available",
    statusLabel: "Available",
    tags: ["compress", "target", "1mb", "size", "shrink", "pdf", "image"],
  },
  {
    id: "svg-minifier",
    slug: "svg-minifier",
